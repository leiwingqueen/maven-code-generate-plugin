 ...
 *
 */
public class ServiceGen extends AbstractGenerater{
	public static final String subPath="service";
	
	public ServiceGen(String projectDir,
			String basePackageName,TableProperty tableProperty) {
		super(getTargetDir(projectDir,basePackageName), tableProperty.getClassName()+"Service.java", "java/Service.vm", basePackageName, null,tableProperty);
	}
