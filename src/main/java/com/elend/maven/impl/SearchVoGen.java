 ...
 *
 */
public class SearchVoGen extends AbstractGenerater{
	public static final String subPath="vo";
	
	public SearchVoGen(String projectDir,
			String basePackageName,TableProperty tableProperty) {
		super(getTargetDir(projectDir,basePackageName), tableProperty.getClassName()+"SearchVO.java", "java/SearchVO.vm", basePackageName, null,tableProperty);
	}
